...
<table  bgcolor="lightblue" width="750" height="500" align="center" style="border-collapse: collapse;" border="1" bordercolor="#006699" >
	<tr>
		<td align="center"><h3>Edit Contact in the Contact Manager App</h3></td>
	</tr>
 		...
 		<form:form action="updateContact.do" method="post" commandName="editContact">
				<table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">					
					...
					<tr>
						...
						<td>
						<form:input path="name" pattern="[a-zA-Z0-9\s]+"/></td>
						<td align="left">
					...
					<tr>
						...
						<td><form:input path="dob" pattern="(0?[1-9]|[12][0-9]|3[01])-(0?[1-9]|1[012])-((19|20)\\d\\d)"/></td>
